...
class ViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    @IBAction func pressSurprise(_ sender: Any) {
    ...
    func fetchData() {
        ...
        URLSession.shared.dataTask(with: url, completionHandler: { data,response,error in
            ...
            var result: quoteStruct?
            do{
                result = try JSONDecoder().decode(quoteStruct.self, from: data)
            }
            catch{
            ...
            UserDefaults.standard.set(json.content, forKey: "quote")
